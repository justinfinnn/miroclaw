  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">MIROFISH LOCAL</div>
      </div>
...
const loadProject = async () => {
  try {
    ...
    if (res.success) {
      ...
      if (res.data.status === 'ontology_generated' && !res.data.graph_id && !res.data.graph_build_task_id) {
        await startBuildGraph()
      } else if ((res.data.status === 'ontology_generated' || res.data.status === 'graph_building') && res.data.graph_build_task_id) {
